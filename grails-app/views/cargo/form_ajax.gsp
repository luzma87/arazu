...
<g:else>
    ...
    <g:form class="form-horizontal" name="frmCargo" id="${cargoInstance?.id}"
        ...
        <elm:fieldRapido claseLabel="col-sm-2" label="Descripcion" claseField="col-sm-6">
            <g:textField name="descripcion" maxlength="63" pattern="${cargoInstance.constraints.descripcion.matches}" required="" class="form-control  required" value="${cargoInstance?.descripcion}"/>
        </elm:fieldRapido>
