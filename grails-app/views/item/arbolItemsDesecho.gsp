    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            function createContextMenu(node) {
                ...
                <g:if test="${session.perfil.codigo=='JFCM' || session.perfil.codigo=='GRNT' }">
                if (esBodega) {
                    items.desechar = desechar;
                }
                </g:if>
                return items;
            }
                ...
                $.ajax({
                    ...
                    success : function (msg) {
                        ...
                        bootbox.dialog({
                            ...
                            buttons : {
                                ok     : {
                                    label     : "<i class=\"fa fa-trash-o\"></i> Desechar",
                                    id        : "btnSave",
