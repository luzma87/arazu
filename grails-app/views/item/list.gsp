...
<html>
    ...
    <!-- botones -->
            ...
            <div class="btn-group pull-right col-md-3">
                <div class="input-group">
                    ...
                    <span class="input-group-btn">
                        <g:link controller="item" action="list" class="btn btn-default btn-search">
        ...
        <table class="table table-condensed table-bordered table-striped table-hover">
            ...
            <tbody>
                <g:if test="${itemInstanceCount > 0}">
                    <g:each in="${itemInstanceList}" status="i" var="itemInstance">
                        <tr data-id="${itemInstance.id}">
                            
                            <td>${itemInstance.descripcion}</td>
                            
                            <td><elm:textoBusqueda busca="${params.search}"><g:fieldValue bean="${itemInstance}" field="tipo"/></elm:textoBusqueda></td>
