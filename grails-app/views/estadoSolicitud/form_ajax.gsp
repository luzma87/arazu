    ...
    <div class="modal-contenido">
        <g:form class="form-horizontal" name="frmEstadoSolicitud" id="${estadoSolicitudInstance?.id}"
            ...
            <elm:fieldRapido claseLabel="col-sm-2" label="Tipo" claseField="col-sm-6">
                <g:select name="tipo" from="${EstadoSolicitud.constraints.tipo.inList}"
                          class="form-control" value="${estadoSolicitudInstance?.tipo}"
                          valueMessagePrefix="estadoSolicitud.tipo"/>
            </elm:fieldRapido>
            ...
            <elm:fieldRapido claseLabel="col-sm-2" label="Descripción" claseField="col-sm-6">
                <g:textArea name="descripcion" class="form-control " value="${estadoSolicitudInstance?.descripcion}" style="height: 200px;"/>
            </elm:fieldRapido>
