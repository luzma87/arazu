...
<html>
    <head>
        ...
        <title>Lista de TipoMaquinaria</title>
    </head>
    <body>
        ...
        <script type="text/javascript">
            ...
            function submitFormTipoMaquinaria() {
                ...
                if ($form.valid()) {
                    ...
                    openLoader("Guardando TipoMaquinaria");
                    $.ajax({
                        type    : "POST",
            ...
            function deleteTipoMaquinaria(itemId) {
                bootbox.dialog({
                    ...
                    message : "<i class='fa fa-trash-o fa-3x pull-left text-danger text-shadow'></i><p>" +
                              "¿Está seguro que desea eliminar el TipoMaquinaria seleccionado? Esta acción no se puede deshacer.</p>",
                    buttons : {
                        cancelar : {
                            label     : "Cancelar",
                        ...
                        eliminar : {
                            ...
                            callback  : function () {
                                openLoader("Eliminando TipoMaquinaria");
                                $.ajax({
                                    type    : "POST",
