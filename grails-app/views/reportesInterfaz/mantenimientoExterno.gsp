    ...
    <body>
        <elm:container tipo="horizontal" titulo="Reporte de mantenimiento externo">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <g:select name="estado" from="${EstadoSolicitud.findAllByTipo('MX', [sort: 'codigo'])}"
        ...
        <script type="text/javascript">
            $("#buscar").click(function () {
                ...
                $.ajax({
                    type    : "POST",
                    url     : "${createLink(controller:'reportesPedidos', action:'reporteMantenimientoExterno_ajax')}",
                    data    : {
                        persona    : $("#persona").val(),
            ...
            $("#imprimir").click(function () {
                ...
                var reporte = "${g.createLink(controller: 'reportesPedidos',action: 'reporteMantenimientoExternoPdf')}?";
